...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <link rel="icon" type="image/svg+xml" sizes="32x32" href="/static/favicons/favicon.svg" />
      <link rel="icon" type="image/svg+xml" sizes="16x16" href="/static/favicons/favicon.svg" />
      <link rel="manifest" href="/static/favicons/site.webmanifest" />
      <link rel="mask-icon" href="/static/favicons/favicon.svg" color="#00000" />
